...
- **Pen preset & eraser:** One user-owned solid-round colour/width preset plus whole-stroke erasure; additional tool kinds, highlighter, and **pressure/tilt curves** remain later scope — card **#155**.
